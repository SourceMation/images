...
def test_os_release_is_debian_11():
    ...
    assert release_info.get('VERSION_ID') == '11'
    assert release_info.get('VERSION_CODENAME') == 'bullseye'
    assert release_info.get('PRETTY_NAME') == 'Debian GNU/Linux 11 (bullseye)'
