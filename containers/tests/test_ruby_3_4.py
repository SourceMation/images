...
def test_ruby_version():
    ...
    assert major_version == 3 and minor_version == 4, f"Expected Ruby version 3.4, but got: {version_info}"
...
def test_irb():
    irb_command = "echo 'puts \"IRB is working!\"; exit' | irb --simple-prompt"
