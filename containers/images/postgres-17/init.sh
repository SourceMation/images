...
wget https://raw.githubusercontent.com/docker-library/postgres/refs/heads/master/17/trixie/docker-entrypoint.sh
wget https://raw.githubusercontent.com/docker-library/postgres/refs/heads/master/17/trixie/docker-ensure-initdb.sh
