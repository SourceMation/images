...
NODE_VERSION=$(git ls-remote --refs --tags https://github.com/nodejs/node.git | grep  -o 'v24.[.0-9]*$'  | tr -d 'v' | sort --version-sort --reverse | head -1)
...
curl -LO https://github.com/nodejs/docker-node/raw/refs/heads/main/24/trixie-slim/docker-entrypoint.sh
