# Apache Tomcat 11.0 Container on Debian 13 Slim packed by Sourcemation

This image, `sourcemation/tomcat-11`, provides a robust and secure **Apache Tomcat 11.0** environment built on a minimal Debian 13 Slim base. It is designed for next-generation Java applications using the `jakarta.*` namespace (Jakarta EE 11).
...
```dockerfile
FROM sourcemation/tomcat-11:latest
...
**Disclaimer:** The `sourcemation/tomcat-11` image is not affiliated with the Apache Software Foundation. The respective companies and organisations own the trademarks mentioned in the offering. The `sourcemation/tomcat-11` image is a separate project and is maintained by [Sourcemation](https://sourcemation.com).
