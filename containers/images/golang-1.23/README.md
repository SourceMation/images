...
## Important Note: Golang 1.23 is End-of-Life (EOL)

This Golang distribution, version 1.23.X, is provided specifically for
compatibility workflows that require an older Golang environment. **Golang 1.23 is
no longer officially supported by the Go project and does not receive security
updates.**

While the Golang 1.23 environment itself is outdated, this Sourcemation image is
