...
This image contains the Java Runtime Environment (JRE) 25 from the Eclipse
...
installation of JRE 25. It is built upon Sourcemation’s optimized Debian 13 Slim
...
This will start a shell inside a container with JRE 25 installed and ready to
use.
...
the Temurin JRE 25 image. **This image runs as the root user! You should
