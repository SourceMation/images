#!/usr/bin/env bash
# ---------------------------------------------------
# Automated build process for the postgresql-18 image
...
wget https://raw.githubusercontent.com/docker-library/postgres/refs/heads/master/18/trixie/docker-entrypoint.sh
wget https://raw.githubusercontent.com/docker-library/postgres/refs/heads/master/18/trixie/docker-ensure-initdb.sh
