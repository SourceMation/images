...
the [Sourcemation platform](https://sourcemation.com/catalog/pgbadger).

For more information, check out the [pgBadger
website](https://pgbadger.darold.net/).

### Licenses

The base license for the solution (pgBadger) is the [PostgreSQL
License](https://github.com/darold/pgbadger/blob/master/LICENSE). The licenses
for each component shipped as part of this image can be found on [the image's
appropriate Sourcemation entry](https://sourcemation.com/catalog/pgbadger).
