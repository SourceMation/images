...
This image contains RabbitMQ Server version 4 running on Debian 12 Slim. It's built on top of the latest compatible Erlang image to ensure compatibility and optimal performance.
