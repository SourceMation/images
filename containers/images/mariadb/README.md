...
The base license for the solution (MariaDB) is the [GPLv2](https://github.com/MariaDB/server/blob/13.0/COPYING). The licenses for each component shipped as part of this image can be found on [the image's appropriate Sourcemation entry](https://sourcemation.com).